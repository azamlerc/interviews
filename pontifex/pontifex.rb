...
[ Test.new("Hello!", "HELLO", "IFMMP",
    Proc.new { Generator.new }),
  Test.new("Do not use PC!", "DONOT USEPC", "OSKJJ JGTMW",
    Proc.new { Example.new }),
  Test.new("Aaaaaaaaaa!", "AAAAA AAAAA", "EXKYI ZSGEH",
    Proc.new { Solitaire.new(nil) }),
  Test.new("Aaaaaaaaaaaaaaa!", "AAAAA AAAAA AAAAA", "ITHZU JIWGR FARMW",
    Proc.new { Solitaire.new("FOO") }),
  Test.new("Solitaire!", "SOLIT AIREX", "KIRAK SFJAN",
